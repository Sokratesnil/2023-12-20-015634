%%%%% LuaLaTeX に依存したパッケージを多数使っている．それ以外のエンジンを使っている人は注意．

%Beamer%
\usepackage{luatexja}% 日本語したい(LuaLaTeX 依存)
...
%%% colour %%%
% https://www.nig.ac.jp/color/gen/ を参考にした色のセット．色覚特性に配慮．
...
%%% Japanese  %%%
\usepackage{luatexja-fontspec} % フォント周りの設定は LuaLaTeX 依存
